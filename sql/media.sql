...
(
  ...
  FILENAME VARCHAR(43) NOT NULL DEFAULT '',
...
COMMENT ON TABLE MEDIA.RATE IS '评分';
COMMENT ON COLUMN MEDIA.RATE.RESOURCE_ID IS '资源标识';
COMMENT ON COLUMN MEDIA.RATE.RATE IS '评分';
COMMENT ON COLUMN MEDIA.RATE.DELETE_STATUS IS '删除状态';
COMMENT ON COLUMN MEDIA.RATE.CREATE_TIME IS '创建时间';
COMMENT ON COLUMN MEDIA.RATE.UPDATE_TIME IS '更新时间';
